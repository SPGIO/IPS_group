...
# was:	lw	_size_reg_19_, 0(_arr_reg_16_)
	ori	$18, $0, 0
# was:	ori	_letBind_15_, 0, 0
	ori	$18, $28, 0
# was:	ori	_letBind_15_, 28, 0
	sll	$10, $16, 2
# was:	sll	_tmp_25_, _size_reg_19_, 2
	addi	$10, $10, 4
...
# was:	sw	_size_reg_19_, 0(_letBind_15_)
	ori	$10, $18, 0
# was:	ori	_ret_reg_17_, _letBind_15_, 0
	sw	$16, 0($10)
# was:	sw	_size_reg_19_, 0(_ret_reg_17_)
	addi	$17, $17, 4
# was:	addi	_arr_reg_16_, _arr_reg_16_, 4
	addi	$10, $10, 4
# was:	addi	_ret_reg_17_, _ret_reg_17_, 4
	ori	$19, $0, 0
...
# was:	lw	_tmp_reg_21_, 0(_arr_reg_16_)
	addi	$17, $17, 4
# was:	addi	_arr_reg_16_, _arr_reg_16_, 4
# 	ori	2,_acc_reg_18_,0
# 	ori	3,_tmp_reg_21_,0
	jal	incr
# was:	jal	incr, 2 3
# 	ori	_tmp_reg_24_,2,0
# 	ori	_acc_reg_18_,_tmp_reg_24_,0
	lw	$10, 0($2)
# was:	lw	_ret_reg_17_, 0(_acc_reg_18_)
	addi	$10, $10, 4
# was:	addi	_ret_reg_17_, _ret_reg_17_, 4
	addi	$19, $19, 1
